...
public class Cliente {
    ...
    public Cliente(int cd_user,String nm_cliente, String nm_endereco, String cd_cpf, String nm_email) {
    ...
    public static ArrayList<Cliente> getClientes() throws Exception{
        ...
        ArrayList<Object[]> list = DbConnection.getQuery(SQL, new Object[]{});
